...
export interface SettingModelType {
  ...
  reducers: {
    ...
    refreshView: Reducer<DefaultSettings>;
    startOptimisticMode: Reducer<DefaultSettings>;
    stopOptimisticMode: Reducer<DefaultSettings>;
  };
}
...
const SettingModel: SettingModelType = {
  ...
  state: defaultSettings,
  reducers: {
    refreshView(state = defaultSettings) {
      return {
        ...state,
        viewVersion: state.viewVersion + 1,
      };
    },
    startOptimisticMode(state = defaultSettings) {
      return {
        ...state,
        optimistic: true,
      };
    },
    stopOptimisticMode(state = defaultSettings) {
      return {
        ...state,
        optimistic: true,
      };
